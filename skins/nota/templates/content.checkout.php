<div id="checkout">
  ...
  <form action="{$VAL_SELF}" method="post" enctype="multipart/form-data" id="basket">
    ...
    {/if}
	<div class="title_swipe"><h2>{$LANG.checkout.your_basket}</h2></div>
	...
	<div class="basket_product">
	  <span class="remove">
		<a href="{$STORE_URL}/index.php?_a=basket&amp;remove-item={$hash}">
		  <img src="skins/{$SKIN_FOLDER}/images/common/basket_remove.png" alt="{$LANG.common.remove}" title="{$LANG.common.remove}" />
		</a>
	  </span>
	  <span class="image">
