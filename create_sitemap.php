...
//////////////////////////////////// Options ////////////////////////////////////
$url = "http://www.pnpdance.com/"; //The Url of the site - the last '/' is needed
...
$sitemap_file = 'sitemap_new.xml'; 

// Stuff to be ignored...
//Ignore the file/folder if these words appear in the name
$always_ignore = array(
	'local_common.php','images','calendar.php'
);
...
$ignore_folders = array(
	'/pnpdance_sandbox/','/MFL_NewSite/','/admin/','/opencart/',
);
