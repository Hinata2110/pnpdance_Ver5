...
{	
	...
	const FUSION_VERSION = '2.3'; // Plugin version
	...
	/**
	 * Returns path to the license validation
	 * file of the current skin
	 */
	public function licenseValidationPath()
	{
		return $this->skinFusionPath().CC_DS.'licensing'.CC_DS.'validate.php';
	}
