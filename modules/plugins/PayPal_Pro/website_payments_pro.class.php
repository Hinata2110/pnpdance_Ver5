	...
	public function __construct($settings = false) {
		...
		if (is_array($settings)) {
			...
			if ($settings['gateway']) {
				...
				$this->_api_paypal_url	= 'https://www.paypal.com/webscr&cmd=_express-checkout&token=';
			} else {
				## Sandbox/Testing Mode
				$this->_api_endpoint	= 'api-3t.sandbox.paypal.com/nvp';
				$this->_api_paypal_url	= 'https://www.sandbox.paypal.com/webscr&cmd=_express-checkout&token=';
			}
		} else {
