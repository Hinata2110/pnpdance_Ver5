<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
  <div id="BarclayCard" class="tab_content">
	...
	<fieldset><legend>{$LANG.barclaycard.settings}</legend>
		...
		<div><label for="post_url">{$LANG.barclaycard.post_url}</label><span><input name="post_url" id="post_url" class="textbox" type="text" value="{$MODULE.fromURL}" readonly="readonly" /></span></div>
  		</fieldset>
