<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
  <div id="USPS" class="tab_content">
	...
	<!--
	<fieldset>
		<legend>Allowed Configurations</legend>
		<table>
			<thead>
				<tr>
					<td>Size</td>
	...
	<fieldset>
		...
		<!--
		<div>
			<label style="width: 350px">{$LANG.common.width}</label>
			<span>
				<input name="module[width]" id="width" class="textbox" type="text" value="{$MODULE.width}" /> (Inches)
			</span>
		</div>
		<div>
			<label style="width: 350px">{$LANG.common.height}</label>
				<span>
					<input name="module[height]" id="height" class="textbox" type="text" value="{$MODULE.height}" /> (Inches)
				</span>
		</div>
		<div>
			<label style="width: 350px">{$LANG.common.length}</label>
			<span>
				<input name="module[length]" id="length" class="textbox" type="text" value="{$MODULE.length}" /> (Inches)
			</span>
		</div>
		<div>
			<label style="width: 350px">Girth</label>
			<span>
				<input name="module[girth]" id="length" class="textbox" type="text" value="{$MODULE.girth}" /> (Inches)
			</span>
		</div>
		-->
