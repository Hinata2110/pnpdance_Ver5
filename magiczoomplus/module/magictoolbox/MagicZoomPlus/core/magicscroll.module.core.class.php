...
if(!defined('MagicScrollModuleCoreClassLoaded')) {
    ...
    class MagicScrollModuleCoreClass {
        ...
        function headers($jsPath = '', $cssPath = null, $notCheck = false) {
            ...
            $headers = array();
            // add module version
            $headers[] = '<!-- Magic Zoom Plus CubeCart (v.3.x and v.4.x) module version v4.0.21 [v1.1.24:v4.0.12] -->';
            // add style link
