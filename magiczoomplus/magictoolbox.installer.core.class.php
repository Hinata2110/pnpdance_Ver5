<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function setBackups() {
            ...
            $this->setError('Installer has modified following CubeCart (v.3.x and v.4.x) files:');
                ...
                while (($file = readdir($dir))!==false) {
                    ...
                    if(is_dir($src . '/' . $file)) {
                        ...
                        if($file == 'magiczoomplus.settings.dat') {
                            ...
                            copy($src . '/magiczoomplus.settings.dat', $dest . '/' . $file);
                        } elseif(($file == 'magiczoomplus.css' || $file == 'magicscroll.css') && $this->resDir != '') {
