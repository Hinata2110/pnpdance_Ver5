...
<?php if ($comments) : ?>
	<div class="responses"><?php comments_number('No Responses', 'One Response', '% Responses' );?> to &#8220;<?php the_title(); ?>&#8221;</div>

	<div class="commentlist">

	<?php foreach ($comments as $comment) : ?>

		<div class="comments_top" <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			<div class="gravatar"><?php echo get_avatar( $comment, 40 ); ?></div>
			<div class="comments_autor"><?php comment_author_link() ?> Says:
		...
		<div class="comments_bot"><?php comment_text() ?></div>
