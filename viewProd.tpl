  ...
  <form action="skins/{VAL_SKIN}/php/ajaxCart.php" method="post" name="addtobasket" target="_self" id="myForm{PRODUCT_ID}">
    ...
    <div id="viewProdTop" class="clearfix">
            ...
            <tr>
              <td valign="middle" align="center" style="text-align:center;">
                  <a href="{IMG_SRC}" class="useLightbox" rel="group">
                    <img id="MainProdImage" src="skins/Sandbox/php/getImg.php?src={IMG_SRC}&amp;width=320&amp;height=305" alt="{TXT_PRODTITLE}" border="0" title="{TXT_PRODTITLE}" />
                  </a>
              </td>
            </tr>
          </table>
        ...
        <div class="span-9 viewProdDetails">
            ...
            <div class="stockLevel"><span id="inStock">{TXT_INSTOCK}</span><span id="outOfStock" class="txtOutOfStock">{TXT_OUTOFSTOCK}</span></div>
            <div class="productCode">Product Code: <span id="prodCode">{TXT_PRODCODE}</span></div>
	...
	<!-- BEGIN: extended_prod_opts -->
	<br />
	<strong>{TXT_PROD_OPTIONS}</strong>
	{EXTENDED_PRODUCT_OPTIONS}
	<!-- END: extended_prod_opts -->
	<!-- *** IMPORTANT NOTE: The "prod_opts" tag below will only be used if
	     *** the Extended Product Options mod is disabled!  When this mod is
	     *** enabled the external viewProdOptions.tpl file will be used instead -->
	<!-- end mod - Extended Product Options - by Estelle -->
            ...
            <table border="0" cellspacing="0" cellpadding="0" id="prodOptions">
              ...
              <tr>
                ...
                <td style="padding-bottom:10px;"><select name="productOptions[{VAL_OPTION_ID}]" class="dropDown" style="margin-left:5px;" onchange="{JS_UPDATE_PRICE}{JS_UPDATE_STOCK_LEVEL}">
                    <!-- BEGIN: repeat_values -->
            ...
            <div class="viewProdButtons">
                <a href="javascript:{JS_VERIFY_SELECTION}{JS_VERIFY_STOCK}{JS_VERIFY_TEXT_INPUT}doAddToCart({PRODUCT_ID});" class="buyBtn singleBtn largeBtn">{BTN_ADDBASKET}<img src="skins/Sandbox/styleImages/backgrounds/buttonArrow.gif" alt="" /></a>
            </div>
            <!-- END: buy_btn -->
          ...
          <tr>
            <td valign="middle" align="center">
                <a href="{VALUE_IMG_SRC}" rel="group" class="useLightbox">
                	<img src="skins/Sandbox/php/getImg.php?src={VALUE_IMG_SRC}&amp;fill=1&amp;width=175&amp;height=175" border="0" alt="{TXT_PRODTITLE}" />
                </a>
            </td>
          </tr>
        </table>
    ...
    <div class="span-8" style="width:208px;">
      <div class="latestProds">
        ...
        <table border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td valign="middle" align="center" style="text-align:center;"><a href="index.php?_a=viewProd&amp;productId={VAL_PRODUCT_ID}"> <img src="skins/Sandbox/php/getImg.php?src={VAL_IMG_SRC}&amp;width=178&amp;height=130" alt="{VAL_PRODUCT_NAME}" border="0" title="{VAL_PRODUCT_NAME}" /> </a> </td>
          </tr>
        </table>
