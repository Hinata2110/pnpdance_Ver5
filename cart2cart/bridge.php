...
class M1_C2c_Config_Adapter
{
  ...
  function detectCartType()
  {
    ...
    //Litecommerce
    if ((file_exists(M1_C2C_STORE_BASE_DIR .'/etc/config.php')) ||
      (file_exists(M1_C2C_STORE_BASE_DIR .'/modules/lc_connector/litecommerce/etc/config.php')) )
    {
       return "Litecommerce";
    }
    //Prestashop11
   ...
   // }
    ...
    //Opencart14
    if ( (file_exists(M1_C2C_STORE_BASE_DIR . "system/startup.php") || (file_exists(M1_C2C_STORE_BASE_DIR . "common.php") ) || (file_exists(M1_C2C_STORE_BASE_DIR . "library/locator.php"))) && file_exists(M1_C2C_STORE_BASE_DIR . "config.php") ){
    ...
    //SunShop
    if( file_exists(M1_C2C_STORE_BASE_DIR . "include" . DIRECTORY_SEPARATOR . "config.php") || file_exists(M1_C2C_STORE_BASE_DIR . "include" . DIRECTORY_SEPARATOR . "db_mysql.php") ) {
      return "Sunshop4";
    }
...
class M1_C2c_Config_Adapter_Tomatocart extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_Tomatocart()
  {
    ...
    if ( file_exists(M1_C2C_STORE_BASE_DIR  . "includes" . DIRECTORY_SEPARATOR . 'application_top.php') ) {
         $conf = file_get_contents (M1_C2C_STORE_BASE_DIR . "includes" . DIRECTORY_SEPARATOR
                . "application_top.php");
         ...
         if (isset($match[0]) && !empty($match[0])){
           ...
           //if another version
          if ( file_exists(M1_C2C_STORE_BASE_DIR  . "includes" . DIRECTORY_SEPARATOR . 'version.php') ) {
             @require_once M1_C2C_STORE_BASE_DIR . "includes" . DIRECTORY_SEPARATOR
               . "version.php";
...
class M1_C2c_Config_Adapter_Cubecart extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_Cubecart()
  {
  ...
  //  $this->imagesDir = 'images/source';
    ...
    while ($dirEntry = readdir($dirHandle)) {
      ...
      if (is_dir(M1_C2C_STORE_BASE_DIR . 'language/' . $dirEntry) || $dirEntry == '.' || $dirEntry == '..' || strpos($dirEntry, "_") !== false || $xmlflag) {
        continue;
      }	
      $configXml = simplexml_load_file(M1_C2C_STORE_BASE_DIR . 'language/'.$dirEntry);
    ...
    if ( file_exists(M1_C2C_STORE_BASE_DIR  . 'ini.inc.php') ) {
         $conf = file_get_contents (M1_C2C_STORE_BASE_DIR . 'ini.inc.php');
    ...
    } elseif ( file_exists(M1_C2C_STORE_BASE_DIR . "includes" . DIRECTORY_SEPARATOR . 'ini.inc.php') ){
	$conf = file_get_contents (M1_C2C_STORE_BASE_DIR . "includes" . DIRECTORY_SEPARATOR . 'ini.inc.php');
         preg_match("/ini\['ver'\].*/", $conf, $match);
         if (isset($match[0]) && !empty($match[0])){
           preg_match("/\d.*/", $match[0], $project);
           if (isset($project[0]) && !empty($project[0])){
  ...
  function M1_C2c_Config_Adapter_WPecommerce()
  {
    ...
    if ( $version != '' ) {
      $this->cartVars['dbVersion'] = $version;
       ...
       if ( file_exists(M1_C2C_STORE_BASE_DIR . "wp-content".DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."wp-shopping-cart".DIRECTORY_SEPARATOR."wp-shopping-cart.php")  ) {
         $conf = file_get_contents (M1_C2C_STORE_BASE_DIR . "wp-content".DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."wp-shopping-cart".DIRECTORY_SEPARATOR."wp-shopping-cart.php");
    ...
    if ( file_exists(M1_C2C_STORE_BASE_DIR . "wp-content/plugins/shopp/Shopp.php") ) {
			...
			$this->manufacturersImagesDir = $this->imagesDir;
		} elseif ( file_exists(M1_C2C_STORE_BASE_DIR . "wp-content/plugins/wp-e-commerce/wp-shopping-cart.php") ) {
...
class M1_C2c_Config_Adapter_Ubercart extends M1_C2c_Config_Adapter
{
  ...
  // Test if database url has a password.
    ...
    if ( file_exists(M1_C2C_STORE_BASE_DIR . "/modules/ubercart/uc_cart/uc_cart.info") ) {
      $str = file_get_contents(M1_C2C_STORE_BASE_DIR . "/modules/ubercart/uc_cart/uc_cart.info");	   
...
class M1_C2c_Config_Adapter_Summercart3 extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_Summercart3()
  {
    ...
    if ( file_exists(M1_C2C_STORE_BASE_DIR . "/include/VERSION") ) {
      $indexFileContent = file_get_contents(M1_C2C_STORE_BASE_DIR . "/include/VERSION");
...
class M1_C2c_Config_Adapter_Litecommerce extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_Litecommerce()
  {
    if ((file_exists(M1_C2C_STORE_BASE_DIR .'/etc/config.php'))){
      $file = M1_C2C_STORE_BASE_DIR .'/etc/config.php';
      $this->imagesDir = "/images"; 
      $this->categoriesImagesDir    = $this->imagesDir."/category";
      $this->productsImagesDir      = $this->imagesDir."/product";
      $this->manufacturersImagesDir = $this->imagesDir;
    } elseif(file_exists(M1_C2C_STORE_BASE_DIR .'/modules/lc_connector/litecommerce/etc/config.php')) {
      $file = M1_C2C_STORE_BASE_DIR .'/modules/lc_connector/litecommerce/etc/config.php';
...
class M1_C2c_Config_Adapter_Hhgmultistore extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_Hhgmultistore()
  {
    ...
    if ( file_exists(M1_C2C_STORE_BASE_DIR . "/core/config/conf.hhg_startup.php") ) {
      $ver = file_get_contents(M1_C2C_STORE_BASE_DIR . "/core/config/conf.hhg_startup.php");
...
class M1_C2c_Config_Adapter_Magento1212 extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_Magento1212()
  {
      ...
      if ( file_exists(M1_C2C_STORE_BASE_DIR . "app/Mage.php") ) {
        $ver = file_get_contents(M1_C2C_STORE_BASE_DIR . "app/Mage.php");
...
class M1_C2c_Config_Adapter_Oscommerce3 extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_Oscommerce3()
  {
    $file = M1_C2C_STORE_BASE_DIR .'/osCommerce/OM/Config/settings.ini';
    $settings=parse_ini_file($file);
...
class M1_C2c_Config_Adapter_Sunshop4 extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_Sunshop4()
  {
    @require_once M1_C2C_STORE_BASE_DIR
...
class M1_C2c_Config_Adapter_Zencart137 extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_Zencart137()
  {
    $cur_dir = getcwd();
...
class M1_C2c_Config_Adapter_XCart extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_XCart()
  {
      ...
      $config = file_get_contents(M1_C2C_STORE_BASE_DIR . "config.php");
      ...
      if(file_exists(M1_C2C_STORE_BASE_DIR . "VERSION")) {
        $version = file_get_contents(M1_C2C_STORE_BASE_DIR . "VERSION");
...
class M1_C2c_Config_Adapter_Virtuemart113 extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_Virtuemart113()
  {
    require_once M1_C2C_STORE_BASE_DIR . "/configuration.php";
      ...
      if ( file_exists(M1_C2C_STORE_BASE_DIR . "/administrator/components/com_virtuemart/version.php") ) {
        $ver = file_get_contents(M1_C2C_STORE_BASE_DIR . "/administrator/components/com_virtuemart/version.php");
      ...
      if ( is_dir( M1_C2C_STORE_BASE_DIR . 'images/stories/virtuemart/product' ) ){
...
class M1_C2c_Config_Adapter_Opencart14 extends M1_C2c_Config_Adapter
{
  function M1_C2c_Config_Adapter_Opencart14()
  {
    ...
    if ( file_exists(M1_C2C_STORE_BASE_DIR . "/index.php") ) {
      $indexFileContent = file_get_contents(M1_C2C_STORE_BASE_DIR . "/index.php");
    }  
    
    if (file_exists(M1_C2C_STORE_BASE_DIR . "/system/startup.php")) {
      $startupFileContent = file_get_contents(M1_C2C_STORE_BASE_DIR . "/system/startup.php");
    }
...
class M1_C2c_Bridge_Action_Clearcache
{
  ...
  function _Oscommerce3ClearCache()
  {
    ...
    $dirs = array(
      M1_C2C_STORE_BASE_DIR . 'osCommerce/OM/Work/Cache/',
    );
