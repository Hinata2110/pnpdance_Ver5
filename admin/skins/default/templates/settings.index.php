...
<div id="General" class="tab_content">
  ...
  <fieldset><legend>{$LANG.settings.title_geographical}</legend>
  ...
  <fieldset><legend>{$LANG.settings.title_tax_lang}</legend>
...
<div id="Features" class="tab_content">
  ...
  <fieldset><legend>{$LANG.settings.google_analytics}</legend>
	<div><label for="google_analytics">{$LANG.settings.google_analytics}</label><span><input name="config[google_analytics]" id="google_analytics" type="text" class="textbox" value="{$CONFIG.google_analytics}" /></span></div>
  </fieldset>

  <fieldset><legend>{$LANG.navigation.nav_prod_reviews}</legend>
  ...
  <fieldset><legend>{$LANG.settings.title_orders}</legend>
	<!--
  ...
  <fieldset><legend>{$LANG.settings.title_sales}</legend>
  ...
  <fieldset><legend>{$LANG.common.misc}</legend>
   ...
   <div><label for="auto_save_cart">{$LANG.settings.auto_save_cart}</label><span><input name="config[auto_save_cart]" id="auto_save_cart" type="hidden" class="toggle" value="{$CONFIG.auto_save_cart}" /></span></div>
...
<div id="Layout" class="tab_content">
  ...
  <fieldset><legend>{$LANG.settings.title_display}</legend>
  ...
  <fieldset><legend>{$LANG.settings.title_popular_latest}</legend>
  ...
  <fieldset><legend>{$LANG.settings.title_skins}</legend>
...
<div id="Stock" class="tab_content">
  ...
  <fieldset><legend>{$LANG.settings.title_digital}</legend>
	...
	<div><label for="download_custom_path">{$LANG.settings.digital_custom_root}</label><span><input name="config[download_custom_path]" id="download_custom_path" type="text" class="textbox" value="{$CONFIG.download_custom_path}" /></span></div>
  </fieldset>
  <fieldset><legend>{$LANG.settings.title_stock_general}</legend>
...
<div id="SSL" class="tab_content">
  ...
  <fieldset><legend>{$LANG.settings.title_ssl}</legend>
...
<div id="Offline" class="tab_content">
  ...
  <fieldset><legend>{$LANG.settings.title_offline}</legend>
  ...
  <div><label for="offline_allow_admin">{$LANG.settings.offline_admin}</label><span><select name="config[offline_allow_admin]" id="offline_allow_admin" class="textbox">
	  {foreach from=$OPT_OFFLINE_ALLOW_ADMIN item=option}<option value="{$option.value}"{$option.selected}>{$option.title}</option>{/foreach}
  </select></span></div>
  </fieldset>
  <fieldset><legend>{$LANG.settings.offline_message}</legend>
...
<div id="Logos" class="tab_content">
  ...
  {if isset($LOGOS)}
  <fieldset class="list"><legend>{$LANG.settings.title_logo_current}</legend>
	  ...
	  <span class="actions">
		...
		<select id="" name="logo[{$logo.logo_id}][skin]" class="textbox select-skin">
		  ...
		  {foreach from=$SKINS_ALL item=skin}
		    ...
		    </optgroup><optgroup label="{$LANG.common.other}">
		    {/if}
  ...
  {/if}
  <fieldset><legend>{$LANG.settings.title_logo_upload}</legend>
...
<div id="Advanced_Settings" class="tab_content">
  ...
  <fieldset><legend>{$LANG.settings.title_performance}</legend>
	...
	<div><label for="cache_memcache_list">{$LANG.settings.cache_memcache}</label><span><input type="text" name="config[cache_memcache_list]" id="cache_memcache_list" class="textbox" value="{$CONFIG.cache_memcache_list}" /></span></div>
  </fieldset>
  <fieldset><legend>{$LANG.settings.title_proxy}</legend>
  ...
  <fieldset><legend>{$LANG.settings.title_time_date}</legend>
  ...
  <fieldset><legend>{$LANG.common.other}</legend>
  ...
  <div><label for="anon_stats">{$LANG.settings.anon_stats}</label><span><input name="config[anon_stats]" id="anon_stats" type="hidden" class="toggle" value="{$CONFIG.anon_stats}" /></span></div>
  </fieldset>
</div>
...
<div id="Extra" class="tab_content">
  ...
  <fieldset><legend>{$LANG.settings.title_product_clone}</legend>
