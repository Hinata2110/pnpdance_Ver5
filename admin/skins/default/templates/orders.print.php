...
<body onload="window.print();">
  ...
  <div class="page-break">
	  <div id="header">
		<div id="printLabel">
		  <div>
		  	{if !empty($order.name_d) && empty($order.last_name_d)}{$order.name_d}{else}{$order.company_name_d}{$order.title_d} {$order.first_name_d} {$order.last_name_d}{/if}<br />
		...
		<div id="storeLabel"><img src="/admin/skins/default/images/ballet1Plate.jpg" width="225" height="191">
		</div>
	  </div>
