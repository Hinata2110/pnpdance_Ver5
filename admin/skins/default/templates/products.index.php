	  ...
	  <table class="list">
		...
		{foreach from=$PRODUCT_OPTIONS item=options}
		  ...
		  <tr id="option_{$option.assign_id}">
			...
			<!-- td><span class="editable number" name="option_update[{$option.assign_id}][option_stock]" title="Click to edit">{$option.option_stock}</span></td -->
			<td align="center">
		  ...
		  <tr id="option_member_{$option.set_member_id}">
			...
			<!-- td><span class="editable number" name="option_create[{$option.set_member_id}][option_stock]" title="Click to edit">{$option.option_stock}</span></td -->
