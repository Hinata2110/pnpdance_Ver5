...
<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
  <div id="general" class="tab_content">
	<fieldset><legend>{$LANG.email.title_overview}</legend>
	  ...
	  <div><label for="sender_name">{$LANG.email.news_sender_email}</label><span><input type="text" name="newsletter[sender_name]" id="sender_name" class="textbox" value="{$NEWSLETTER.sender_name}" /> ({$LANG.email.empty_equals_default})</span></div>
	  <div><label for="sender_email">{$LANG.email.news_sender_name}</label><span><input type="text" name="newsletter[sender_email]" id="sender_email" class="textbox" value="{$NEWSLETTER.sender_email}" /> ({$LANG.email.empty_equals_default})</span></div>
...
<div class="tab_content" id="newsletter_send">
  <div id="progress_wrapper">
	...
	<div id="progress_bar"><img src="images/loading.gif" alt="" class="newsletter" /></div>
  </div>
