...
class XTemplate extends XTemplate_original {
    ...
    function XTemplate() {
        ...
        if(self::$moduleStatus === null) {
            $module = fetchDbConfig('MagicThumb');
            if($module === false) {
    ...
    function text ($bname = '') {
        ...
        // BUT we need all this variables into included file (magicthumb.php)
        ...
        if(self::$moduleStatus) {
            ...
            require_once(CC_ROOT_DIR . '/modules/magictoolbox/MagicThumb/core/magicthumb.php');
            $text = MagicThumb($text, $bname);
        }
