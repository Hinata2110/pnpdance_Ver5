<?php /* Smarty version Smarty-3.1.8, created on 2012-11-19 13:03:53
         compiled from "/hermes/bosweb26a/b1803/ipg.pnpdancecom/admin/skins/default/templates/dashboard.index.php" */ ?>
<?php /*%%SmartyHeaderCode:11167077950aa2e3979ba02-16958847%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c0beed8fecd3d8ffa5fa39945db79a383e410ae1' => 
    array (
      0 => '/hermes/bosweb26a/b1803/ipg.pnpdancecom/admin/skins/default/templates/dashboard.index.php',
      1 => 1352288030,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11167077950aa2e3979ba02-16958847',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_50aa2e39da39a8_09097401',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50aa2e39da39a8_09097401')) {function content_50aa2e39da39a8_09097401($_smarty_tpl) {?><div id="dashboard" class="tab_content">
...
" class="edit"><img src="<?php echo $_smarty_tpl->tpl_vars['SKIN_VARS']->value['admin_folder'];?>
/skins/<?php echo $_smarty_tpl->tpl_vars['SKIN_VARS']->value['skin_folder'];?>
/images/edit.png" alt="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['common']['edit'];?>
" /></a></span>
	  <a href="?_g=products&amp;action=edit&amp;product_id=<?php echo $_smarty_tpl->tpl_vars['warn']->value['product_id'];?>
#product_stock"><?php echo $_smarty_tpl->tpl_vars['warn']->value['name'];?>
</a> (<?php echo $_smarty_tpl->tpl_vars['LANG']->value['dashboard']['stock_level'];?>
: <?php echo $_smarty_tpl->tpl_vars['warn']->value['stock_level'];?>
)
	</div>
  <?php } ?>
  </div>
