...
ALTER TABLE `CubeCart_option_assign` ADD `option_use_stock` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0'; #EOQ
ALTER TABLE `CubeCart_option_assign` ADD `option_stock` INT NULL DEFAULT '0'; #EOQ
