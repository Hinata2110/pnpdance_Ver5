	...
	<div id="main">
		...
		<div id="navigation">
			...
			<ul id="nav">
				...
				<li class="page_item nav_help"><a id="nav_help" href="http://dereferer.ws/?http://www.appnitro.com/documentation" target="_blank" title="Help">Help</a></li>
				...
				<li class="page_item nav_logout"><a id="nav_logout" href="logout.php" title="Sign Out">Sign Out</a></li>
            </ul>
