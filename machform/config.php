...
define('MF_DB_NAME', 'pnpdanceforms'); //The name of your database. Note that this database must exist before running installer.php
define('MF_DB_USER', 'pnpforms'); //Your database username
define('MF_DB_PASSWORD', 'jad3lo'); //Your database users password
define('MF_DB_HOST', 'pnpdancecom.ipagemysql.com'); //The hostname for your database
